...
export const GlydusLogo: React.FC<{ className?: string }> = ({ className }) => (
...
export const SaveContactIcon: React.FC<{ className?: string; style?: React.CSSProperties }> = ({ className, style }) => (
...
export const EmailIcon: React.FC<{className?: string; style?: React.CSSProperties}> = ({ className, style }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const NfcIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3.75h16.5a2.25 2.25 0 012.25 2.25v12a2.25 2.25 0 01-2.25-2.25H3.75a2.25 2.25 0 01-2.25-2.25v-12a2.25 2.25 0 012.25-2.25z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M5.625 3.75V18.375m3.75-14.625V18.375m3.75-14.625V18.375m3.75-14.625V18.375M2.25 5.625h19.5m-19.5 7.5h19.5" />
    </svg>
);
...
export const QRCodeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5a.75.75 0 00-.75.75v3.75c0 .414.336.75.75.75h3.75a.75.75 0 00.75-.75V5.25a.75.75 0 00-.75-.75H3.75zM9 4.5a.75.75 0 01.75.75v3.75c0 .414-.336.75-.75.75H5.25a.75.75 0 01-.75-.75V5.25A.75.75 0 015.25 4.5H9zM3.75 15a.75.75 0 00-.75.75v3.75c0 .414.336.75.75.75h3.75a.75.75 0 00.75-.75v-3.75a.75.75 0 00-.75-.75H3.75zM9 15a.75.75 0 01.75.75v3.75c0 .414-.336.75-.75.75H5.25a.75.75 0 01-.75-.75v-3.75A.75.75 0 015.25 15H9zM15 4.5a.75.75 0 00-.75.75v3.75c0 .414.336.75.75.75h3.75a.75.75 0 00.75-.75V5.25a.75.75 0 00-.75-.75H15zM15 9.75a.75.75 0 01.75-.75h3.75a.75.75 0 01.75.75v3.75a.75.75 0 01-.75.75H15a.75.75 0 01-.75-.75V9.75zM15 15a.75.75 0 00-.75.75v3.75c0 .414.336.75.75.75h3.75a.75.75 0 00.75-.75v-3.75a.75.75 0 00-.75-.75H15z" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 12h.008v.008H3V12zm.75 3.75h.008v.008H3.75v-.008zm.75-3h.008v.008H4.5V12zm1.5.75h.008v.008H6v-.008zm1.5-1.5h.008v.008H7.5v-.008zm-3 4.5h.008v.008H4.5v-.008zm3-3.75h.008v.008H7.5v-.008zm3 .75h.008v.008H10.5v-.008zm-3-3h.008v.008H7.5V12z" />
    </svg>
);